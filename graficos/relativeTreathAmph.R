...
myMap3(rstThreatment, rstMask, crs_to, title,"(CR+EN+VU)/Richness", 1, paste0(folderResults, folderGraph))
...
for(order in orders){
  ...
  myMap3(rstThreatment, rstMask, crs_to, title2,"(CR+EN+VU)/Richness", 1, paste0(folderResults, folderGraph))
}
