...
p<- ggplot(df2) +
  geom_bar(aes(x=as.factor(nlevel1), y = percent, fill= className), stat = "identity", position = "dodge") +
  #scale_y_log10()+
...
# ggsave(
#   paste0(folderResults,folderGraph,"/threatTables_all_percentage.png"),
#   #ggplot_alternative(),
#   width = 10,
#   height = 5,
#   dpi = 300
