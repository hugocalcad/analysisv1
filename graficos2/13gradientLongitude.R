...
myGraphLongitude(rstSpecie, rstMask, crs_to, title, "", paste0(folderResults, folderGraph), fun = fun)
...
myGraphLongitude(rst_DD, rstMask, crs_to, title2, "", paste0(folderResults, folderGraph), fun = fun)
...
myGraphLongitude(rst_Threat, rstMask, crs_to, title2, "(CR + EN + VU)", paste0(folderResults, folderGraph), fun = fun)
