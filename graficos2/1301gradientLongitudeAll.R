...
title <- "All Classes"
myGraphLongitudeAll(rstSpecie1,rstSpecie2,rstSpecie3,rstSpecie4, rstMask, crs_to, title, "", paste0(folderResults, folderGraph), fun = "mean")
myGraphLongitudeAllRelative(rstSpecie1,rstSpecie2,rstSpecie3,rstSpecie4, rstMask, crs_to, title, "", paste0(folderResults, folderGraph), fun = "mean")
