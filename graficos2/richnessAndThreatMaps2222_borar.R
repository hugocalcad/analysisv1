...
myMapGeneric(rstSpecie, rstMask, crs_to, title, "", 2, paste0(folderResults, folderGraph), 
             oceans = 0, annotateScale = "", scaleFun = scaleFun, 
             nameSave = paste0("sum_all_",title,"_0v2"))
## plotting order
...
for(order in orders){
  ...
  myMapGeneric(rstSpecie, rstMask, crs_to, title2, "", 2, paste0(folderResults, folderGraph), 
               oceans = 0, annotateScale = "", scaleFun = scaleFun, 
...
myMapGeneric(rstThreatment, rstMask, crs_to, title, "", 2, paste0(folderResults, folderGraph), 
             oceans = 0, annotateScale = "", scaleFun = scaleFun, 
...
for(order in orders){
  ...
  rstThreatment <- rst_EN + rst_VU + rst_CR
  title2 <- paste0(title,'_',order)
  myMapGeneric(rstThreatment, rstMask, crs_to, title2, "", 2, paste0(folderResults, folderGraph), 
               oceans = 0, annotateScale = "", scaleFun = scaleFun, 
